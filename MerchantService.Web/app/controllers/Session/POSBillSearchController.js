var POSBillSearchController = (function () {
    function POSBillSearchController($scope, $log, $rootScope, ReturnBillService, ngToast, $location, filterFilter, $routeParams, apiPath, $modal) {
        var _this = this;
        this.$scope = $scope;
        this.$log = $log;
    ...
    POSBillSearchController.prototype.initialize = function () {
        this.getbillList();
        this.getBranchList();
    };
    //this method used for Start Date Picker -An
    POSBillSearchController.prototype.openStartDatePickerDate = function (event) {
        event.preventDefault();
        event.stopPropagation();
        this.$scope.isStartPickerDateOpened = true;
    };
    //this method used for end date Picker -An
    POSBillSearchController.prototype.openEndDatePickerDate = function (event) {
        event.preventDefault();
        event.stopPropagation();
        this.$scope.isEndPickerDateOpened = true;
    };
    //this funciton used for get branch list. -An
    POSBillSearchController.prototype.getBranchList = function () {
        var _this = this;
    ...
    POSBillSearchController.prototype.getbillList = function () {
        var _this = this;
    ...
    POSBillSearchController.prototype.GetPOSBillList = function (result) {
    ...
    POSBillSearchController.prototype.clickOnsearchButton = function () {
        var controllerScope = this.$scope;
    ...
    return POSBillSearchController;
}());
POSBillSearchController.controllerId = "POSBillSearchController";
app.controller(POSBillSearchController.controllerId, ['$scope', '$log', '$rootScope', 'ReturnBillService', 'ngToast', '$location', 'filterFilter', '$routeParams', 'apiPath', '$modal', function ($scope, $log, $rootScope, ReturnBillService, ngToast, $location, filterFilter, $routeParams, apiPath, $modal) {
        return new POSBillSearchController($scope, $log, $rootScope, ReturnBillService, ngToast, $location, filterFilter, $routeParams, apiPath, $modal);
    }]);
//# sourceMappingURL=POSBillSearchController.js.map