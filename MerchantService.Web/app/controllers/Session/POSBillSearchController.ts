...
interface IPOSBillSearchControllerScope extends ng.IScope {
...
interface IPOSBillSearchController {

}

class POSBillSearchController implements IPOSBillSearchController {
    static controllerId = "POSBillSearchController";
    constructor(private $scope: IBillSearchControllerScope, private $log: ng.ILogService, public $rootScope, private ReturnBillService: ReturnBillService, public ngToast, public $location, public filterFilter, public $routeParams, public apiPath, public $modal) {
...
app.controller(POSBillSearchController.controllerId, ['$scope', '$log', '$rootScope', 'ReturnBillService', 'ngToast', '$location', 'filterFilter', '$routeParams', 'apiPath', '$modal', ($scope, $log, $rootScope, ReturnBillService, ngToast, $location, filterFilter, $routeParams, apiPath, $modal) => {
